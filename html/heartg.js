...
function load() {
  ...
  document.getElementById("pinkboard").remove();
  ...
  setInterval(function () {
    a.fillStyle = "rgba(04,08,20,0.1)"; // clear screen
    a.fillRect(1, 0, O, Q);
    ...
    while (i--) {
      ...
      while (k < v - 1) {
        ...
        N.x -= (N.x - T.x) * 0.9; // use zenos paradox to create trail
        N.y -= (N.y - T.y) * 0.9;
